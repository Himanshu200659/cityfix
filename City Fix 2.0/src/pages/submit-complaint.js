...
const SubmitComplaintPage = {
            ...
            <div class="form-step" id="step-2" style="display:none;">
              ...
              <div class="form-group">
                ...
                <div class="file-preview" id="image-preview" style="display:none;">
                  ...
                  <button class="btn btn-ghost btn-sm" id="remove-image" style="margin-top:8px;color:var(--danger-500);">✕ Remove</button>
                </div>
              </div>
  ...
  init() {
    ...
    if (uploadArea && fileInput) {
      ...
      uploadArea.addEventListener('drop', (e) => {
        ...
        if (e.dataTransfer.files.length) page.handleImage(e.dataTransfer.files[0]);
      });
      fileInput.addEventListener('change', (e) => {
        if (e.target.files.length) page.handleImage(e.target.files[0]);
      });
    }

    document.getElementById('remove-image')?.addEventListener('click', () => {
      page.selectedImage = null;
  ...
  handleImage(file) {
    ...
    SubmitComplaintPage.selectedImage = file;
  ...
  async submit() {
    ...
    try {
      ...
      if (page.selectedImage) {
        imageUrl = await DB.uploadImage(page.selectedImage);
      }
