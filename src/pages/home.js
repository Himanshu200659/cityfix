...
const HomePage = {
          ...
          <div class="hero-content">
            <div class="hero-text">
              ...
              <div class="hero-stats">
                <div class="hero-stat">
                  <div class="hero-stat-value" id="hero-reported" data-count="0">0</div>
                  <div class="hero-stat-label">Issues Reported</div>
                </div>
                <div class="hero-stat">
                  <div class="hero-stat-value" id="hero-resolved" data-count="0">0</div>
                  <div class="hero-stat-label">Issues Resolved</div>
                </div>
                <div class="hero-stat">
                  <div class="hero-stat-value" id="hero-satisfaction" data-count="0">0</div>
  ...
  async init() {
    ...
    try {
      ...
      setVal('hero-reported', stats.total);
      setVal('hero-resolved', stats.resolved);
      
      let sat = 0;
      if (stats.total > 0) sat = Math.round((stats.resolved / stats.total) * 100);
      setVal('hero-satisfaction', sat);

      setVal('stat-citizens', usersCount);
      setVal('stat-reported', stats.total);
